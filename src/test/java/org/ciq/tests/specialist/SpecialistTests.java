...
public class SpecialistTests extends BaseTest {
    ...
    //TC1 : CIQ-3582
    @Test(groups = {"specialist","specialistHealthCarePlan", "CarePlan", "mammogram"})
    ...
    //TC2 : CIQ-3350
    @Test(groups = {"specialist","specialistHealthCarePlan", "Aromatase","CarePlan"})
    ...
    //TC3
    @Test(groups = {"specialist","HBOC", "HCC", "updateTestResult"})
    public void specialistHBOCAndHCC() throws InterruptedException {
        ...
        specialistPendingDashBoardPage.clickCreatePatientButton()
                ...
                .clickButton("Submit")
                .addFamilyMember("Add Family Member", data.get("Family Grouping2"))
                ...
                .clickReviewPatient()
                .clickPatientNavigationTab("Testing")
                .validateHbocAndHccStatus("class","switch ng-valid","fa check-icon fa-check-circle bg-green")
                ...
                .clickButton("NEXT")
                .clickButton("PRINT")
                .checkTestResultPanel(data.get("Test"))
                ...
                .clickButton("Save Test Results")
                .validateSavedAdditionalResults(data.get("TestName3"),data.get("AdditionalTestResultOption"))
